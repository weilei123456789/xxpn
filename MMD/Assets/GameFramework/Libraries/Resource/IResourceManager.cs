...
namespace GameFramework.Resource
{
    ...
    public interface IResourceManager
    {
        ...
        /// 课件
        /// </summary>
        List<CoursewareUpdate> CoursewareUpdate
        {
            get;
        }

        string CoursewareSearchPath
        {
            set;
            get;
        }
        ...
        void UpdateCoursewareResources(CoursewareUpdate[] coursewareUpdateArray, UpdateResourcesCompleteCallback updateCoursewareResourcesCompleteCallback);
