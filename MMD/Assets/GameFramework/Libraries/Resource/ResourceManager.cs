...
namespace GameFramework.Resource
{
    ...
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        private UpdateResourcesCompleteCallback m_UpdateCoursewareResourcesCompleteCallback;
        ...
        public List<CoursewareUpdate> CoursewareUpdate
        {
            get;
        }
        public string CoursewareSearchPath
        {
            set;
            get;
        }
        ...
        public ResourceManager()
        {
            ...
            m_UpdateCoursewareResourcesCompleteCallback = null;
            ...
            CoursewareUpdate = new List<CoursewareUpdate>();
        }
        ...
        internal override void Shutdown()
        {
            ...
            if (m_ResourceChecker != null)
            {
                ...
                m_ResourceChecker.CoursewareUpdateInfo -= OnCoursewareUpdateInfo;
            ...
            if (m_ResourceUpdater != null)
            {
                ...
                m_ResourceUpdater.ResourceUpdateAllComplete -= OnUpdaterResourceUpdateExceptCoursewareAllComplete;
        ...
        {
            if (updateCoursewareResourcesCompleteCallback == null)
            {
                throw new GameFrameworkException("Update Courseware resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable)
            {
                throw new GameFrameworkException("You can not use UpdateCoursewareResources without updatable resource mode.");
            }

            if (m_ResourceUpdater == null)
            {
                throw new GameFrameworkException("You can not use UpdateCoursewareResources at this time.");
            }

            m_UpdateCoursewareResourcesCompleteCallback = updateCoursewareResourcesCompleteCallback;
            m_ResourceUpdater.UpdateCoursewareResources(coursewareUpdateArray);
        }
        ...
        private void OnCoursewareUpdateInfo(ResourceName resourceName, int loadType, int length, int hashCode, int zipLength, int zipHashCode, bool isNeedUpdate)
        {
            CoursewareUpdate.Add(new CoursewareUpdate(
                                 new CoursewareResourceName(resourceName.Name, resourceName.Variant),
                                 loadType, length, hashCode, zipLength, zipHashCode,
                                 Utility.Path.GetCombinePath(m_ReadWritePath, Utility.Path.GetResourceNameWithSuffix(resourceName.FullName)),
                                 Utility.Path.GetRemotePath(m_UpdatePrefixUri, Utility.Path.GetResourceNameWithCrc32AndSuffix(resourceName.FullName, hashCode)),
                                 0, isNeedUpdate));
        }
        ...
        private void OnUpdaterResourceUpdateExceptCoursewareAllComplete()
        {
            m_ResourceUpdater.ResourceUpdateAllComplete -= OnUpdaterResourceUpdateExceptCoursewareAllComplete;
            m_ResourceUpdater.ResourceUpdateAllComplete += OnUpdaterCoursewareResourceUpdateAllComplete;

            m_UpdateResourcesCompleteCallback();
            m_UpdateResourcesCompleteCallback = null;
        }

        private void OnUpdaterCoursewareResourceUpdateAllComplete()
        {
            m_ResourceUpdater.ResourceUpdateStart -= OnUpdaterResourceUpdateStart;
            m_ResourceUpdater.ResourceUpdateChanged -= OnUpdaterResourceUpdateChanged;
            m_ResourceUpdater.ResourceUpdateSuccess -= OnUpdaterResourceUpdateSuccess;
            ...
            CoursewareUpdate.Clear();

            m_UpdateCoursewareResourcesCompleteCallback();
            m_UpdateCoursewareResourcesCompleteCallback = null;
        }
    }
}
