...
namespace GameFramework.Resource
{
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceChecker
        {
            ...
            public GameFrameworkAction<ResourceName, int, int, int, int, int, bool> CoursewareUpdateInfo;
            ...
            private void RefreshCheckInfoStatus()
            {
                ...
                foreach (KeyValuePair<ResourceName, CheckInfo> checkInfo in m_CheckInfos)
                {
                    ...
                    if (ci.ResourceName.Name.Contains(m_ResourceManager.CoursewareSearchPath))
                    {
                        CoursewareUpdateInfo(ci.ResourceName, (int)ci.LoadType, ci.Length, ci.HashCode, ci.ZipLength, ci.ZipHashCode, isNeedUpdate);
                    }
