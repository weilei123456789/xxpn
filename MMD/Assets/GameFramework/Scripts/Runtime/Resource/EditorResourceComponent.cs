...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class EditorResourceComponent : MonoBehaviour, IResourceManager
    {
        ...
        public List<CoursewareUpdate> CoursewareUpdate
        {
            get
            {
                throw new NotSupportedException("CoursewareUpdate");
            }
        }
        ...
        public string CoursewareSearchPath
        {
            set
            {
                throw new NotSupportedException("CoursewareSearchPath");
            }
            get
            {
                throw new NotSupportedException("CoursewareSearchPath");
...
#pragma warning restore 0067, 0414
        ...
        public void DownloadLesson(params string[] lessonName)
        {
            throw new NotSupportedException("DownloadLesson");
        }
